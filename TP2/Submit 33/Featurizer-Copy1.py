...
def getTarget1Cols():
    return ['ciudad_target_precio', 'idzona_target_precio', 'tipodepropiedad_target_precio', 'provincia_target_precio']  

def getTarget2Cols():
    return ['tipodepropiedad_target_antiguedad']  

def getTarget3Cols():
    return ['ciudad_target_mtot', 'idzona_target_mtot', 'tipodepropiedad_target_mtot', 'provincia_target_mtot']  

def getTarget4Cols():
    return ['ciudad_target_m2', 'idzona_target_m2', 'tipodepropiedad_target_m2', 'provincia_target_m2']  
...
def preprocess(x, encode1, encode2, encodingType, encode3=None,encode4=None,encode5=None,encode6=None,encode7=None, y1 = None ):
    ...
    if (encodingType == 'train'):
        ...
        if encode6:
            y4 = features.metroscubiertostotales
